document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".r-r-navigation-list");
  const headerRef = document.querySelector(".r-r-header");
  const navigationRef = document.querySelector(".r-r-navigation");
  ...
  document.querySelectorAll(".r-r-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".r-r-toggle-button img");
